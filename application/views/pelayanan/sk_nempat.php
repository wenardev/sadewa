            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="pd-20 card-box">
                        <h5 class="h4 text-blue mb-20">Form Surat Keterangan Untuk Orang Tua (N4)</h5>
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tambah" role="tabpanel">
                                    <form action="<?= base_url('pelayanan/sk_nempat_tambah'); ?>" method="POST">
                                        <div class="pd-20">
                                            <div class="row">
                                                <div class="col-lg">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="<?= base_url('pelayanan/sk_nempat_pdf/') . $d->id; ?>" target="_blank"><i class="dw dw-print"></i> Print/PDF</a>
    ...
    <div class="modal fade" id="detail<?= $d->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_nempat_detail'); ?>" method="POST">
    ...
    <div class="modal fade" id="ubah<?= $d->kode_surat ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_nempat_ubah'); ?>" method="POST">
...
<?php $i = 0;
foreach ($sk_nempat as $d) : $i++ ?>
<form action="<?php echo site_url('pelayanan/sk_nempat_hapus'); ?>" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="submit" href="<?php echo site_url('pelayanan/sk_nempat_hapus/') . $d->kode_surat; ?>" class="btn btn-danger">Hapus</a>
                    </div>
            </div>
        </div>
    </div>
