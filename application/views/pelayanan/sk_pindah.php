    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <?= form_error('warganegara', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
              ...
              <?= form_error('alamat_baru', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>', '</div>'); ?>
              <?= form_error('no_rt_baru', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>', '</div>'); ?>
              <?= form_error('no_rw_baru', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>', '</div>'); ?>
              <?= form_error('kode_pos_baru', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>', '</div>'); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="pd-20 card-box">
                        <h5 class="h4 text-blue mb-20">Form Surat Keterangan Pindah</h5>
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tambah" role="tabpanel">
                                    <form action="<?= base_url('pelayanan/sk_pindah_tambah'); ?>" method="POST">
                                        <div class="pd-20">
                                            <div class="row">
                                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="pengikut">Pengikut</label>
                                                        <input type="text" class="form-control text-dark" id="pengikut" name="pengikut" value="<?= set_value('pengikut') ?>" placeholder="Pengikut">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="alamatpenduudk">Alamat Asal</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="alamat_baru">Alamat Baru</label>
                                                        <textarea type="text" class="form-control text-dark" name="alamat_baru" id="alamat_baru" value="<?= set_value('alamat_baru') ?>" placeholder="Alamat Baru"><?= set_value('alamat_baru') ?></textarea>
                                                        <?= form_error('alamat_baru', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rt_baru">No RT Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rt_baru" name="no_rt_baru" value="<?= set_value('no_rt_baru') ?>" placeholder="Nomor RT Baru">
                                                        <?= form_error('no_rt_baru', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rw_baru">No RW Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rw_baru" name="no_rw_baru" value="<?= set_value('no_rw_baru') ?>" placeholder="Nomor RW Baru">
                                                        <?= form_error('no_rw_baru', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="kode_pos_baru">Kode Pos Baru</label>
                                                        <input type="number" class="form-control text-dark" id="kode_pos_baru" name="kode_pos_baru" value="<?= set_value('kode_pos_baru') ?>" placeholder="Kode Pos Baru">
                                                        <?= form_error('kode_pos_baru', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($sk_pindah as $skp) : ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?= $skp->tempat_lahir ?>, <?= date('d/m/y', strtotime($skp->tanggal_lahir)) ?>
                                                        </td>
                                                        <td class="text-green">
                                                            <b><?= $skp->nama_surat ?></b>
                                                        </td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="<?= base_url('pelayanan/sk_pindah_pdf/') . $skp->id; ?>" target="_blank"><i class="dw dw-print"></i> Print/PDF</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#detail<?= $skp->id; ?>"><i class="dw dw-eye"></i> Detail</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#ubah<?= $skp->kode_surat; ?>"><i class="dw dw-edit2"></i> Ubah</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#hapus<?= $skp->kode_surat; ?>"><i class="dw dw-delete-3"></i> Hapus</a>
                                                                 </div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
<!-- Modal detail -->
<?php $i = 0;
foreach ($sk_pindah as $skp) : $i++ ?>
    <div class="modal fade" id="detail<?= $skp->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/pindah_detail'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $skp->id ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_surat">No Surat</label>
                                    <input class="form-control text-dark" value="<?= $skp->no_surat ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-control-label" for="nik">Nik</label>
                                    <input class="form-control text-dark" value="<?= $skp->nik ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama">Nama</label>
                                    <input class="form-control text-dark" value="<?= $skp->nama ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= $skp->tempat_lahir ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir">Tanggal Lahir</label>
                                    <input class="form-control text-dark" value="<?= date('d/m/y', strtotime($skp->tanggal_lahir)); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="jenis_kelamin">Jenis Kelamin</label>
                                    <input class="form-control text-dark" value="<?= $skp->jenis_kelamin ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= $skp->agama ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="warga_negara">Warga Negara</label>
                                    <input class="form-control text-dark" value="<?= $skp->warga_negara ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pendidikanterakhir">Pendidikan Terakhir</label>
                                    <input class="form-control text-dark" value="<?= $skp->pendidikan_terakhir ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= $skp->status_kawin ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan">Pekerjaan</label>
                                    <input class="form-control text-dark" value="<?= $skp->pekerjaan ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control text-dark" name="alamatpenduduk" id="alamatpenduduk" readonly><?= $skp->alamat ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_rt">No RT</label>
                                    <input class="form-control text-dark" value="<?= $skp->no_rt ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_rw">No RW</label>
                                    <input class="form-control text-dark" value="<?= $skp->no_rw ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="kode_pos">Kode Pos</label>
                                    <input class="form-control text-dark" value="<?= $skp->kode_pos ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="alamat_baru">Alamat Baru</label>
                                                        <textarea type="text" class="form-control text-dark" readonly><?= $skp->alamat_baru ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rt_baru">No RT Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rt_baru" name="no_rt_baru" value="<?= $skp->no_rt_baru ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rw_baru">No RW Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rw_baru" name="no_rw_baru" value="<?= $skp->no_rw_baru ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="kode_pos_baru">Kode Pos Baru</label>
                                                        <input type="number" class="form-control text-dark" id="kode_pos_baru" name="kode_pos_baru" value="<?= $skp->kode_pos_baru ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                    </div>
...
<?php $i = 0;
foreach ($sk_pindah as $skp) : $i++ ?>
    <div class="modal fade" id="ubah<?= $skp->kode_surat ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('pelayanan/sk_pindah_ubah'); ?>" method="POST">
                    <input type="hidden" name="kode_surat" id="kode_surat" value="<?= $skp->kode_surat ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_surat">No Surat</label>
                                    <input type="number" class="form-control text-dark" id="no_surat" name="no_surat" value="<?= $skp->no_surat ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-control-label" for="nik">No NIK</label>
                                    <input type="number" class="form-control text-dark" id="nik" name="nik" value="<?= $skp->nik ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama">Nama</label>
                                    <input type="text" class="form-control text-dark" id="nama" name="nama" value="<?= $skp->nama ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir">Tempat Lahir</label>
                                    <input type="text" class="form-control text-dark" id="tempat_lahir" name="tempat_lahir" value="<?= $skp->tempat_lahir ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir">Tanggal Lahir</label>
                                    <input type="date" class="form-control text-dark" id="tanggal_lahir" name="tanggal_lahir" value="<?= $skp->tanggal_lahir ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="jenis_kelamin" name="jenis_kelamin" class="form-control">
                                        <option value="<?= $skp->jenis_kelamin ?>"><?= $skp->jenis_kelamin ?></option>
                                        <option>Laki - laki</option>
                                        <option>Perempuan</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="agama" name="agama" class="form-control">
                                        <option value="<?= $skp->agama ?>"><?= $skp->agama ?></option>
                                        <?php foreach ($agama as $aga) : ?>
                                            <option value="<?= $aga['agama']; ?>">
                                                <?= $aga['agama']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="pendidikan_terakhir" name="pendidikan_terakhir" class="form-control">
                                        <option value="<?= $skp->pendidikan_terakhir ?>"><?= $skp->pendidikan_terakhir ?></option>
                                        <option>Tidak Sekolah</option>
                                        <option>SD</option>
                                        <option>SMP</option>
                                        <option>SMA/SMK</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="warga_negara" name="warga_negara" class="form-control">
                                        <option value="<?= $skp->warga_negara ?>"><?= $skp->warga_negara ?></option>
                                        <option>WNI</option>
                                        <option>WNA</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="status_kawin" name="status_kawin" class="form-control">
                                        <option value="<?= $skp->status_kawin ?>"><?= $skp->status_kawin ?></option>
                                        <option>Belum Menikah</option>
                                        <option>Menikah</option>
                                        <option>Duda</option>
                                        <option>Janda</option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="pekerjaan" name="pekerjaan" class="form-control">
                                        <option value="<?= $skp->pekerjaan ?>"><?= $skp->pekerjaan ?></option>
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    <label class="form-control-label" for="alamat">Alamat</label>
                                    <textarea class="form-control text-dark" id="alamat" name="alamat" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')"><?= $skp->alamat ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="no_rt" name="no_rt" class="form-control">
                                        <option value="<?= $skp->no_rt ?>"><?= $skp->no_rt ?></option>
                                        <?php foreach ($rt as $t) : ?>
                                            <option value="<?= $t['no_rt']; ?>">
                                                <?= $t['no_rt']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="no_rw" name="no_rw" class="form-control">
                                        <option value="<?= $skp->no_rw ?>"><?= $skp->no_rw ?></option>
                                        <?php foreach ($rw as $w) : ?>
                                            <option value="<?= $w['no_rw']; ?>">
                                                <?= $w['no_rw']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="kode_pos">Kode Pos</label>
                                    <input type="number" class="form-control text-dark" id="kode_pos" name="kode_pos" value="<?= $skp->kode_pos ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="alamat_baru">Alamat Baru</label>
                                                        <textarea type="text" class="form-control text-dark" name="alamat_baru" id="alamat_baru" placeholder="Alamat Baru" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')"><?= $skp->alamat_baru ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rt_baru">No RT Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rt_baru" name="no_rt_baru" value="<?= $skp->no_rt_baru ?>" placeholder="Nomor RT Baru" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="no_rw_baru">No RW Baru</label>
                                                        <input type="number" class="form-control text-dark" id="no_rw_baru" name="no_rw_baru" value="<?= $skp->no_rw_baru ?>" placeholder="Nomor RW Baru" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="kode_pos_baru">Kode Pos Baru</label>
                                                        <input type="number" class="form-control text-dark" id="kode_pos_baru" name="kode_pos_baru" value="<?= $skp->kode_pos_baru ?>" placeholder="Kode Pos Baru" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                                    </div>
                                                </div>
                                            </div>
                    </div>
...
<?php $i = 0;
foreach ($sk_pindah as $skp) : $i++ ?>
<form action="<?php echo site_url('pelayanan/sk_pindah_hapus'); ?>" method="POST">
    <div class="modal fade" id="hapus<?= $skp->kode_surat ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="submit" href="<?php echo site_url('pelayanan/sk_pindah_hapus/') . $skp->kode_surat; ?>" class="btn btn-danger">Hapus</a>
                    </div>
            </div>
        </div>
    </div>
