    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <?= form_error('kodepos', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
              ...
              <?= form_error('keterangan', '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>', '</div>'); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="pd-20 card-box">
                        <h5 class="h4 text-blue mb-20">Form Surat Keterangan Izin Orang Tua</h5>
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tambah" role="tabpanel">
                                    <form action="<?= base_url('pelayanan/sk_izin_orang_tua_tambah'); ?>" method="POST">
                                        <div class="pd-20">
                                            <div class="row">
                                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control text-dark" id="no_surat" name="no_surat"value="<?= set_value('no_surat') ?>" placeholder="Nomor NIK">
                                            ...
                                            <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control text-dark" name="keterangan" id="keterangan"  placeholder="Keterangan alasan membuat surat tersebut... "><?= set_value('keterangan') ?></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control text-dark" id="tempat_lahir_ayah" name="tempat_lahir_ayah" value="<?= set_value('tempat_lahir_ayah') ?>" placeholder="Tempat Lahir Ayah">
                                                        <?= form_error('tempat_lahir_ayah', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="tanggal_lahir_ayah">Tanggal Lahir Ayah</label>
                                                        <input type="date" class="form-control text-dark" id="tanggal_lahir_ayah" name="tanggal_lahir_ayah" value="<?= set_value('tanggal_lahir_ayah') ?>">
                                                        <?= form_error('tanggal_lahir_ayah', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control text-dark" id="tanggal_lahir_ibu" name="tanggal_lahir_ibu" value="<?= set_value('tanggal_lahir_ibu') ?>">
                                ...
                                <div class="tab-pane fade" id="table" role="tabpanel">
                                    <div class="pd-20">
                                        <table class="data-table table stripe hover nowrap">
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                <?php foreach ($sk_izin_orang_tua as $skiot) : ?>
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?= ucwords($skiot->tempat_lahir); ?>, <?= date('d/m/y', strtotime($skiot->tanggal_lahir)) ?>
                                                        </td>
                                                        <td class="text-green">
                                                            <b><?= $skiot->nama_surat ?></b>
                                                        </td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="<?= base_url('pelayanan/sk_izin_orang_tua_pdf/') . $skiot->id; ?>" target="_blank"><i class="dw dw-print"></i> Print/PDF</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#detail<?= $skiot->id; ?>"><i class="dw dw-eye"></i> Detail</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#ubah<?= $skiot->kode_surat; ?>"><i class="dw dw-edit2"></i> Ubah</a>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#hapus<?= $skiot->kode_surat; ?>"><i class="dw dw-delete-3"></i> Hapus</a>
                                                                 </div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
<!-- Modal detail -->
<?php $i = 0;
foreach ($sk_izin_orang_tua as $skiot) : $i++ ?>
    <div class="modal fade" id="detail<?= $skiot->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/domisili_detail'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $skiot->id ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label"><b>Biodata Pemohon</b></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_surat">No Surat</label>
                                    <input class="form-control text-dark" value="<?= $skiot->no_surat ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-control-label" for="nik">Nik</label>
                                    <input class="form-control text-dark" value="<?= $skiot->nik ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama">Nama</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->nama); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->tempat_lahir); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir">Tanggal Lahir</label>
                                    <input class="form-control text-dark" type="date" value="<?= date('d/m/y', strtotime($skiot->tanggal_lahir)); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="jenis_kelamin">Jenis Kelamin</label>
                                    <input class="form-control text-dark" value="<?= $skiot->jenis_kelamin ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= $skiot->agama ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="warga_negara">Warga Negara</label>
                                    <input class="form-control text-dark" value="<?= $skiot->warga_negara ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pendidikanterakhir">Pendidikan Terakhir</label>
                                    <input class="form-control text-dark" value="<?= $skiot->pendidikan_terakhir ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-dark" value="<?= $skiot->status_kawin ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan">Pekerjaan</label>
                                    <input class="form-control text-dark" value="<?= $skiot->pekerjaan ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control text-dark" name="alamatpenduduk" id="alamatpenduduk" readonly><?= ucwords($skiot->alamat); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_rt">No RT</label>
                                    <input class="form-control text-dark" value="<?= $skiot->no_rt ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_rw">No RW</label>
                                    <input class="form-control text-dark" value="<?= $skiot->no_rw ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="kode_pos">Kode Pos</label>
                                    <input class="form-control text-dark" value="<?= $skiot->kode_pos ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="keterangan">Keterangan</label>
                                    <textarea type="text" class="form-control text-dark" name="keterangan" id="keterangan" readonly><?= ucwords($skiot->keterangan); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label"><b>Biodata Orang Tua</b></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama_ayah">Nama Ayah</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->nama_ayah); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir_ayah">Tempat Lahir Ayah</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->tempat_lahir_ayah); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir_ayah">Tanggal Lahir Ayah</label>
                                    <input class="form-control text-dark" type="date" value="<?= $skiot->tanggal_lahir_ayah ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan_ayah">Pekerjaan Ayah</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->pekerjaan_ayah); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama_ibu">Nama Ibu</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->nama_ibu); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir_ibu">Tempat Lahir Ibu</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->tempat_lahir_ibu); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir_ibu">Tanggal Lahir Ibu</label>
                                    <input class="form-control text-dark" type="date" value="<?= $skiot->tanggal_lahir_ibu ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan_ibu">Pekerjaan Ibu</label>
                                    <input class="form-control text-dark" value="<?= ucwords($skiot->pekerjaan_ibu); ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $i = 0;
foreach ($sk_izin_orang_tua as $skiot) : $i++ ?>
    <div class="modal fade" id="ubah<?= $skiot->kode_surat ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('pelayanan/sk_izin_orang_tua_ubah'); ?>" method="POST">
                    <input type="hidden" name="kode_surat" id="kode_surat" value="<?= $skiot->kode_surat ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="no_surat">No Surat</label>
                                    <input type="number" class="form-control text-dark" id="no_surat" name="no_surat" value="<?= $skiot->no_surat ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-control-label" for="nik">No Nik</label>
                                    <input type="number" class="form-control text-dark" id="nik" name="nik" value="<?= $skiot->nik ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama">Nama</label>
                                    <input type="text" class="form-control text-dark" id="nama" name="nama" value="<?= ucwords($skiot->nama); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir">Tempat Lahir</label>
                                    <input type="text" class="form-control text-dark" id="tempat_lahir" name="tempat_lahir" value="<?= ucwords($skiot->tempat_lahir); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir">Tanggal Lahir</label>
                                    <input type="date" class="form-control text-dark" id="tanggal_lahir" name="tanggal_lahir" value="<?= $skiot->tanggal_lahir ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="jenis_kelamin" name="jenis_kelamin" class="form-control">
                                        <option value="<?= $skiot->jenis_kelamin ?>"><?= $skiot->jenis_kelamin ?></option>
                                        <option>Laki - laki</option>
                                        <option>Perempuan</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="agama" name="agama" class="form-control">
                                        <option value="<?= $skiot->agama ?>"><?= $skiot->agama ?></option>
                                        <?php foreach ($agama as $aga) : ?>
                                            <option value="<?= $aga['agama']; ?>">
                                                <?= $aga['agama']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="pendidikan_terakhir" name="pendidikan_terakhir" class="form-control">
                                        <option value="<?= $skiot->pendidikan_terakhir ?>"><?= $skiot->pendidikan_terakhir ?></option>
                                        <option>Tidak Sekolah</option>
                                        <option>SD</option>
                                        <option>SMP</option>
                                        <option>SMA/SMK</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="warga_negara" name="warga_negara" class="form-control">
                                        <option value="<?= $skiot->warga_negara ?>"><?= $skiot->warga_negara ?></option>
                                        <option>WNI</option>
                                        <option>WNA</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="status_kawin" name="status_kawin" class="form-control">
                                        <option value="<?= $skiot->status_kawin ?>"><?= $skiot->status_kawin ?></option>
                                        <option>Belum Menikah</option>
                                        <option>Menikah</option>
                                        <option>Duda</option>
                                        <option>Janda</option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="pekerjaan" name="pekerjaan" class="form-control">
                                        <option value="<?= $skiot->pekerjaan ?>"><?= $skiot->pekerjaan ?></option>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="alamat">Alamat</label>
                                    <textarea class="form-control text-dark" id="alamat" name="alamat" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')"><?= ucwords($skiot->alamat); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="no_rt" name="no_rt" class="form-control">
                                        <option value="<?= $skiot->no_rt ?>"><?= $skiot->no_rt ?></option>
                                        <?php foreach ($rt as $t) : ?>
                                            <option value="<?= $t['no_rt']; ?>">
                                                <?= $t['no_rt']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select id="no_rw" name="no_rw" class="form-control">
                                        <option value="<?= $skiot->no_rw ?>"><?= $skiot->no_rw ?></option>
                                        <?php foreach ($rw as $w) : ?>
                                            <option value="<?= $w['no_rw']; ?>">
                                                <?= $w['no_rw']; ?>
                                            </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="kode_pos">Kode Pos</label>
                                    <input type="number" class="form-control text-dark" id="kode_pos" name="kode_pos" value="<?= $skiot->kode_pos ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="keterangan">Keterangan</label>
                                    <textarea class="form-control text-dark" id="keterangan" name="keterangan" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')"><?= ucwords($skiot->keterangan); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama_ayah">Nama Ayah</label>
                                    <input type="text" class="form-control text-dark" id="nama_ayah" name="nama_ayah" value="<?= ucwords($skiot->nama_ayah); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir_ayah">Tempat Lahir Ayah</label>
                                    <input type="text" class="form-control text-dark" id="tempat_lahir_ayah" name="tempat_lahir_ayah" value="<?= ucwords($skiot->tempat_lahir_ayah); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir_ayah">Tanggal Lahir Ayah</label>
                                    <input type="date" class="form-control text-dark" id="tanggal_lahir_ayah" name="tanggal_lahir_ayah" value="<?= $skiot->tanggal_lahir_ayah ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan_ayah">Pekerjaan Ayah</label>
                                    <select id="pekerjaan_ayah" name="pekerjaan_ayah" class="form-control">
                                        <option value="<?= $skiot->pekerjaan_ayah ?>"><?= $skiot->pekerjaan_ayah ?></option>
                                        <?php foreach ($pekerjaan as $pk) : ?>
                                            <option value="<?= $pk['pekerjaan']; ?>">
                                                <?= $pk['pekerjaan']; ?>
                                            </option>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama_ibu">Nama Ibu</label>
                                    <input type="text" class="form-control text-dark" id="nama_ibu" name="nama_ibu" value="<?= ucwords($skiot->nama_ibu); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_lahir_ibu">Tempat Lahir Ibu</label>
                                    <input type="text" class="form-control text-dark" id="tempat_lahir_ibu" name="tempat_lahir_ibu" value="<?= ucwords($skiot->tempat_lahir_ibu); ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_lahir_ibu">Tanggal Lahir Ibu</label>
                                    <input type="date" class="form-control text-dark" id="tanggal_lahir_ibu" name="tanggal_lahir_ibu" value="<?= $skiot->tanggal_lahir_ibu ?>" required oninvalid="this.setCustomValidity('Data masih kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pekerjaan_ibu">Pekerjaan Ibu</label>
                                    <select id="pekerjaan_ibu" name="pekerjaan_ibu" class="form-control">
                                        <option value="<?= $skiot->pekerjaan_ibu ?>"><?= $skiot->pekerjaan_ibu ?></option>
                                        <?php foreach ($pekerjaan as $pk) : ?>
                                            <option value="<?= $pk['pekerjaan']; ?>">
                                                <?= $pk['pekerjaan']; ?>
                                            </option>
...
<?php $i = 0;
foreach ($sk_izin_orang_tua as $skiot) : $i++ ?>
<form action="<?php echo site_url('pelayanan/sk_izin_orang_tua_hapus'); ?>" method="POST">
    <div class="modal fade" id="hapus<?= $skiot->kode_surat ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="submit" href="<?php echo site_url('pelayanan/sk_izin_orang_tua_hapus/') . $skiot->kode_surat; ?>" class="btn btn-danger">Hapus</a>
                    </div>
            </div>
        </div>
    </div>
