        ...
        <table class="">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td colspan="10">
                        &emsp;ORANG TERSEBUT DIATAS, ADALAH BENAR-BENAR WARGA RT.<?= $ex->no_rt; ?> RW.<?= $ex->no_rw; ?> DESA <?= $ex->kelurahan; ?> KECAMATAN <?= $ex->kecamatan; ?> KABUPATEN <?= $ex->kabupaten; ?> SURAT PENGANTAR INI DIBUAT SEBAGAI KELENGKAPAN PENGURUSAN <b>EKTP (ELEKTRONIK KARTU TANDA PENDUDUK)</b>.
