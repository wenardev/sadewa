            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="pd-20 card-box">
                        <h5 class="h4 text-blue mb-20">Form Surat Keterangan Kematian</h5>
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tambah" role="tabpanel">
                                    <form action="<?= base_url('pelayanan/sk_kematian_tambah'); ?>" method="POST">
                                        <div class="pd-20">
                                            <div class="row">
                                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control text-dark" id="nonik" name="nonik" value="<?= set_value('nonik') ?>" placeholder="Nomor NIK" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="tempat_kematian">Tempat Kematian</label>
                                                        <input type="text" class="form-control text-dark" id="tempat_kematian" name="tempat_kematian" value="<?= set_value('tempat_kematian') ?>" placeholder="Tempat Kematian">
                                                        <?= form_error('tempat_kematian', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="tanggal_kematian">Tanggal Kematian</label>
                                                            <input type="date" class="form-control text-dark" id="tanggal_kematian" name="tanggal_kematian" value="<?= set_value('tanggal_kematian') ?>" placeholder="Tanggal Kematian">
                                                            <?= form_error('tanggal_kematian', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                </div>
                                                <div class="col-lg-2">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="jam">Jam</label>
                                                            <input type="time" class="form-control text-dark" id="jam" name="jam" value="<?= set_value('jam') ?>" placeholder="Jam">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="penyebab_kematian">Penyebab Kematian</label>
                                                        <input type="text" class="form-control text-dark" id="penyebab_kematian" name="penyebab_kematian" value="<?= set_value('penyebab_kematian') ?>" placeholder="Penyebab Kematian">
                                                        <?= form_error('penyebab_kematian', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="pelapor">Pelapor Kematian</label>
                                                            <input type="text" class="form-control text-dark" id="pelapor" name="pelapor" value="<?= set_value('pelapor') ?>" placeholder="Nama Pelapor Kematian">
                                                            <?= form_error('pelapor', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                </div>
                                                <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="hubungan">Hubungan</label>
                                                            <input type="text" class="form-control text-dark" id="hubungan" name="hubungan" value="<?= set_value('hubungan') ?>" placeholder="Hubungan">
                                                            <?= form_error('hubungan', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="<?= base_url('pelayanan/sk_kematian_pdf/') . $d->id; ?>" target="_blank"><i class="dw dw-print"></i> Print/PDF</a>
    ...
    <div class="modal fade" id="detail<?= $d->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_kematian_detail'); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="tempat_kematian">Tempat Kematian</label>
                                                        <input type="text" class="form-control text-dark" value="<?= $d->tempat_kematian ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="tanggal_kematian">Tanggal Kematian</label>
                                                            <input type="date" class="form-control text-dark" value="<?= $d->tanggal_kematian ?>" readonly>
                                                        </div>
                                                </div>
                                                <div class="col-lg-2">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="jam">Jam</label>
                                                            <input type="time" class="form-control text-dark" value="<?=  date('H:i', strtotime($d->jam));?>" readonly>
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="penyebab_kematian">Penyebab Kematian</label>
                                                        <input type="text" class="form-control text-dark" value="<?= $d->penyebab_kematian ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="pelapor">Pelapor Kematian</label>
                                                            <input type="text" class="form-control text-dark" value="<?= $d->pelapor ?>" readonly>
                                                        </div>
                                                </div>
                                                <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="hubungan">Hubungan</label>
                                                            <input type="text" class="form-control text-dark" value="<?= $d->hubungan ?>" readonly>
                                                        </div>
                                                </div>
                                            </div>
                        <div class="row">
    ...
    <div class="modal fade" id="ubah<?= $d->kode_surat ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_kematian_ubah'); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                <label class="form-control-label" for="no_surat">No Surat</label>
                                    <input type="text" class="form-control text-dark" id="no_surat" name="no_surat" value="<?= $d->no_surat ?>" required oninvalid="this.setCustomValidity('Data Kosong')" oninput="setCustomValidity('')">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-control-label" for="nik">No NIK</label>
                                    <input type="number" class="form-control text-dark" id="nik" name="nik" value="<?= $d->nik ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="tempat_kematian">Tempat Kematian</label>
                                    <input type="text" class="form-control text-dark" id="tempat_kematian" name="tempat_kematian" value="<?= $d->tempat_kematian ?>" placeholder="Tempat Kematian">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="tanggal_kematian">Tanggal Kematian</label>
                                    <input type="date" class="form-control text-dark" id="tanggal_kematian" name="tanggal_kematian" value="<?= $d->tanggal_kematian ?>" placeholder="Tanggal Kematian">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label class="form-control-label" for="jam">Jam</label>
                                    <input type="time" class="form-control text-dark" id="jam" name="jam" value="<?=  date('H:i', strtotime($d->jam));?>" placeholder="Jam">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="penyebab_kematian">Penyebab Kematian</label>
                                    <input type="text" class="form-control text-dark" id="penyebab_kematian" name="penyebab_kematian" value="<?= $d->penyebab_kematian ?>" placeholder="Penyebab Kematian">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="pelapor">Pelapor Kematian</label>
                                    <input type="text" class="form-control text-dark" id="pelapor" name="pelapor" value="<?= $d->pelapor ?>" placeholder="Nama Pelapor Kematian">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="hubungan">Hubungan</label>
                                    <input type="text" class="form-control text-dark" id="hubungan" name="hubungan" value="<?= $d->hubungan ?>" placeholder="Hubungan">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<?php $i = 0;
foreach ($sk_kematian as $d) : $i++ ?>
<form action="<?php echo site_url('pelayanan/sk_kematian_hapus'); ?>" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="submit" href="<?php echo site_url('pelayanan/sk_kematian_hapus/') . $d->kode_surat; ?>" class="btn btn-danger">Hapus</a>
                    </div>
            </div>
        </div>
    </div>
