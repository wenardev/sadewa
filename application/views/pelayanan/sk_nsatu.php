            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                    <div class="pd-20 card-box">
                        <h5 class="h4 text-blue mb-20">Form Surat Keterangan Nikah (N1)</h5>
                        <div class="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tambah" role="tabpanel">
                                    <form action="<?= base_url('pelayanan/sk_nsatu_tambah'); ?>" method="POST">
                                        <div class="pd-20">
                                            <div class="row">
                                                <div class="col-lg">
                                                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                                                        <strong>Informasi!</strong> Inputkan data secara lengkap untuk dapat menggunakan fitur auto input di submenu N2 - N5.
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="calon" name="calon" class="form-control">
                                                            <option value="<?= set_value('calon') ?>"><?= set_value('calon') ?></option>
                                                            <option>Suami</option>
                                                            <option>Istri</option>
                                                        </select>
                                                        <?= form_error('calon', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="status" name="status" class="form-control">
                                                            <option value="<?= set_value('status') ?>"><?= set_value('status') ?></option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control text-dark" id="tanggal_lahir_ayah" name="tanggal_lahir_ayah" value="<?= set_value('tanggal_lahir_ayah') ?>" placeholder="Tanggal Lahir Ayah">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="agama_ayah" name="agama_ayah" class="form-control">
                                                            <option value="<?= set_value('agama_ayah') ?>"><?= set_value('agama_ayah') ?></option>
                                                            <?php foreach ($agama as $aga) : ?>
                                                                <option value="<?= $aga['agama']; ?>">
                                                                    <?= $aga['agama']; ?>
                                                                </option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="warga_negara_ayah" name="warga_negara_ayah" class="form-control">
                                                            <option value="<?= set_value('warga_negara_ayah') ?>"><?= set_value('warga_negara_ayah') ?></option>
                                                            <option>WNI</option>
                                                            <option>WNA</option>
                                                        </select>
                                                        <?= form_error('warga_negara_ayah', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="calon_pasangan" name="calon_pasangan" class="form-control">
                                                            <option value="<?= set_value('calon_pasangan') ?>"><?= set_value('calon_pasangan') ?></option>
                                                            <option>Suami</option>
                                                            <option>Istri</option>
                                                        </select>
                                                        <?= form_error('calon_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?= form_error('tempat_lahir_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="tanggal_lahir_pasangan">Tanggal Lahir Pasangan</label>
                                                        <input type="date" class="form-control text-dark" id="tanggal_lahir_pasangan" name="tanggal_lahir_pasangan" value="<?= set_value('tanggal_lahir_pasangan') ?>">
                                                        <?= form_error('tanggal_lahir_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?= form_error('agama_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?= form_error('warga_negara_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <?= form_error('pekerjaan_pasangan', '<small class="text-danger">', '</small>'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control text-dark" name="alamat_pasangan" id="alamat_pasangan" value="<?= set_value('alamat_pasangan') ?>" placeholder="Alamat Pasangan"><?= set_value('alamat_pasangan') ?></textarea>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                                    <a class="dropdown-item" href="<?= base_url('pelayanan/sk_nsatu_pdf/') . $d->id; ?>" target="_blank"><i class="dw dw-print"></i> Print/PDF</a>
    ...
    <div class="modal fade" id="detail<?= $d->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_nsatu_detail'); ?>" method="POST">
    ...
    <div class="modal fade" id="ubah<?= $d->kode_surat ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pelayanan/sk_nsatu_ubah'); ?>" method="POST">
...
<?php $i = 0;
foreach ($sk_nsatu as $d) : $i++ ?>
<form action="<?php echo site_url('pelayanan/sk_nsatu_hapus'); ?>" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="submit" href="<?php echo site_url('pelayanan/sk_nsatu_hapus/') . $d->kode_surat; ?>" class="btn btn-danger">Hapus</a>
                    </div>
            </div>
        </div>
    </div>
