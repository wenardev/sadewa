            ...
            <div class="card-box mb-30">
                ...
                <div class="pb-20">
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tfoot>
                            <tr>
                                <td class="table-plus datatable-nosort" colspan="2">Jumlah KK</td>
                                <td colspan="4"><?= $count_kk; ?></td>
                            </tr>
                            <tr>
                                <td class="table-plus datatable-nosort" colspan="2">Jumlah EKTP</td>
                                <td colspan="4"><?= $count_ektp; ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('penduduk/kk_tambah'); ?>" method="POST">
    ...
    <div class="modal fade" id="detail<?= $kk->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('penduduk/kk_detail'); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="nama_kepala_keluarga">Nama</label>
    ...
    <div class="modal fade" id="ubah<?= $kk->id ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('penduduk/kk_ubah'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $kk->id ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
    ...
    <div class="modal fade" id="hapus<?= $kk->id ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('penduduk/kk_hapus'); ?>" method="POST">
                    <input type="hidden" name="id" class="id">
                    <div class="modal-body">Yakin ingin menghapus data?</div>
                    <div class="modal-footer">
                        <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                        <a type="submit" href="<?= base_url('penduduk/kk_hapus/') . $kk->id ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </form>
            </div>
        </div>
