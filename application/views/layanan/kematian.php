                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="<?= base_url('layanan/kematian_print/') . $kk->id ?>" target="_blank"><i class="dw dw-print"></i> Print</a>
                                                <a class="dropdown-item" href="<?= base_url('layanan/kematian_pdf/') . $kk->id ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Pdf</a>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('layanan/kematian_tambah'); ?>" method="POST">
    ...
    <div class="modal fade" id="detail<?= $kk->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/kematian_detail'); ?>" method="POST">
    ...
    <div class="modal fade" id="ubah<?= $kk->id ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/kematian_ubah'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $kk->id ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label" for="anak_ke">Anak Ke</label>
                                    <input type="number" class="form-control text-dark" id="anak_ke" name="anak_ke" value="<?= $kk->anak_ke ?>">
                                    <?= form_error('anak_ke', '<small class="text-danger">', '</small>'); ?>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="hapus<?= $kk->id ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/kematian_hapus'); ?>" method="POST">
                    <input type="hidden" name="id" class="id">
                    <div class="modal-body">Yakin ingin menghapus data?</div>
                    <div class="modal-footer">
                        <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                        <a type="submit" href="<?= base_url('layanan/kematian_hapus/') . $kk->id ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </form>
            </div>
        </div>
