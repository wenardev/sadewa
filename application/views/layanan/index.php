                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="<?= base_url('layanan/spektp_print/') . $ektp->id ?>" target="_blank"><i class="dw dw-print"></i> Print</a>
                                                <a class="dropdown-item" href="<?= base_url('layanan/spektp_pdf/') . $ektp->id ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Pdf</a>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('layanan/spektp_tambah'); ?>" method="POST">
    ...
    <div class="modal fade" id="detail<?= $ektp->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/spektp_detail'); ?>" method="POST">
    ...
    <div class="modal fade" id="ubah<?= $ektp->id ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/spektp_ubah'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $ektp->id ?>">
                    <div class="modal-body">
    ...
    <div class="modal fade" id="hapus<?= $ektp->id ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/spektp_hapus'); ?>" method="POST">
                    <input type="hidden" name="id" class="id">
                    <div class="modal-body">Yakin ingin menghapus data?</div>
                    <div class="modal-footer">
                        <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                        <a type="submit" href="<?= base_url('layanan/spektp_hapus/') . $ektp->id ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </form>
            </div>
        </div>
