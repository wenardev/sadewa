                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="<?= base_url('layanan/domisili_print/') . $ektp->id ?>" target="_blank"><i class="dw dw-print"></i> Print</a>
                                                <a class="dropdown-item" href="<?= base_url('layanan/domisili_pdf/') . $ektp->id ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Pdf</a>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('layanan/domisili_tambah'); ?>" method="POST">
    ...
    <div class="modal fade" id="detail<?= $ektp->id ?>" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/domisili_detail'); ?>" method="POST">
    ...
    <div class="modal fade" id="ubah<?= $ektp->id ?>" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/domisili_ubah'); ?>" method="POST">
                    <input type="hidden" name="id" id="id" value="<?= $ektp->id ?>">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="jenis_kelamin">Jenis Kelamin</label>
                                    <select id="jenis_kelamin" name="jenis_kelamin" class="form-control">
                                        <option value="<?= $ektp->jenis_kelamin ?>"><?= $ektp->jenis_kelamin ?></option>
                                        <option>Laki-laki</option>
                                        <option>Perempuan</option>
                                    </select>
                                    <?= form_error('jenis_kelamin', '<small class="text-danger">', '</small>'); ?>
    ...
    <div class="modal fade" id="hapus<?= $ektp->id ?>" tabindex="-1" role="dialog" aria-labelledby="hapusLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('layanan/domisili_hapus'); ?>" method="POST">
                    <input type="hidden" name="id" class="id">
                    <div class="modal-body">Yakin ingin menghapus data?</div>
                    <div class="modal-footer">
                        <button class="btn btn-primary" type="button" data-dismiss="modal">Batal</button>
                        <a type="submit" href="<?= base_url('layanan/domisili_hapus/') . $ektp->id ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </form>
            </div>
        </div>
