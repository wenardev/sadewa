...
<tr>
<td colspan="12">
&emsp;&emsp;&emsp;Orang tersebut diatas, adalah benar - benar warga RT.<?= $ex->no_rt; ?> RW.<?= $ex->no_rw; ?> Desa <?= $ex->kelurahan; ?> Kecamatan <?= $ex->kecamatan; ?> Kabupaten <?= $ex->kabupaten; ?> Surat pengantar ini dibuat sebagai kelengkapan pengurusan <b>DOMISILI</b>.
