...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Agu 2022 pada 08.50
...
CREATE TABLE `pengajuan_kk` (
  ...
  `no_kitab` varchar(100) NOT NULL,
  `nama_ayah` varchar(100) NOT NULL,
  `nama_ibu` varchar(100) NOT NULL,
  `nik_pasangan` varchar(100) NOT NULL,
  `nama_pasangan` varchar(100) NOT NULL,
  `tempat_lahir_pasangan` varchar(100) NOT NULL,
  `tanggal_lahir_pasangan` varchar(100) NOT NULL,
  `jenis_kelamin_pasangan` varchar(100) NOT NULL,
  `agama_pasangan` varchar(100) NOT NULL,
  `status_kawin_pasangan` varchar(100) NOT NULL,
  `warga_negara_pasangan` varchar(100) NOT NULL,
  `pendidikan_terakhir_pasangan` varchar(100) NOT NULL,
  `pekerjaan_pasangan` varchar(100) NOT NULL,
  `status_keluarga_pasangan` varchar(100) NOT NULL,
  `no_paspor_pasangan` varchar(100) NOT NULL,
  `no_kitab_pasangan` varchar(100) NOT NULL,
  `nama_ayah_pasangan` varchar(100) NOT NULL,
  `nama_ibu_pasangan` varchar(100) NOT NULL,
  `nik_anak_satu` varchar(20) NOT NULL,
  `nama_anak_satu` varchar(20) NOT NULL,
  `tempat_lahir_anak_satu` varchar(20) NOT NULL,
  `tanggal_lahir_anak_satu` varchar(20) NOT NULL,
  `jenis_kelamin_anak_satu` varchar(20) NOT NULL,
  `agama_anak_satu` varchar(20) NOT NULL,
  `status_kawin_anak_satu` varchar(20) NOT NULL,
  `warga_negara_anak_satu` varchar(20) NOT NULL,
  `pendidikan_terakhir_anak_satu` varchar(20) NOT NULL,
  `pekerjaan_anak_satu` varchar(20) NOT NULL,
  `status_keluarga_anak_satu` varchar(20) NOT NULL,
  `no_paspor_anak_satu` varchar(20) NOT NULL,
  `no_kitab_anak_satu` varchar(20) NOT NULL,
  `nama_ayah_anak_satu` varchar(20) NOT NULL,
  `nama_ibu_anak_satu` varchar(20) NOT NULL,
  `nik_anak_dua` varchar(20) NOT NULL,
  `nama_anak_dua` varchar(20) NOT NULL,
  `tempat_lahir_anak_dua` varchar(20) NOT NULL,
  `tanggal_lahir_anak_dua` varchar(20) NOT NULL,
  `jenis_kelamin_anak_dua` varchar(20) NOT NULL,
  `agama_anak_dua` varchar(20) NOT NULL,
  `status_kawin_anak_dua` varchar(20) NOT NULL,
  `warga_negara_anak_dua` varchar(20) NOT NULL,
  `pendidikan_terakhir_anak_dua` varchar(20) NOT NULL,
  `pekerjaan_anak_dua` varchar(20) NOT NULL,
  `status_keluarga_anak_dua` varchar(20) NOT NULL,
  `no_paspor_anak_dua` varchar(20) NOT NULL,
  `no_kitab_anak_dua` varchar(20) NOT NULL,
  `nama_ayah_anak_dua` varchar(20) NOT NULL,
  `nama_ibu_anak_dua` varchar(20) NOT NULL,
  `nik_anak_tiga` varchar(20) NOT NULL,
  `nama_anak_tiga` varchar(20) NOT NULL,
  `tempat_lahir_anak_tiga` varchar(20) NOT NULL,
  `tanggal_lahir_anak_tiga` varchar(20) NOT NULL,
  `jenis_kelamin_anak_tiga` varchar(20) NOT NULL,
  `agama_anak_tiga` varchar(20) NOT NULL,
  `status_kawin_anak_tiga` varchar(20) NOT NULL,
  `warga_negara_anak_tiga` varchar(20) NOT NULL,
  `pendidikan_terakhir_anak_tiga` varchar(20) NOT NULL,
  `pekerjaan_anak_tiga` varchar(20) NOT NULL,
  `status_keluarga_anak_tiga` varchar(20) NOT NULL,
  `no_paspor_anak_tiga` varchar(20) NOT NULL,
  `no_kitab_anak_tiga` varchar(20) NOT NULL,
  `nama_ayah_anak_tiga` varchar(20) NOT NULL,
  `nama_ibu_anak_tiga` varchar(20) NOT NULL,
  `nik_anak_empat` varchar(20) NOT NULL,
  `nama_anak_empat` varchar(20) NOT NULL,
  `tempat_lahir_anak_empat` varchar(20) NOT NULL,
  `tanggal_lahir_anak_empat` varchar(20) NOT NULL,
  `jenis_kelamin_anak_empat` varchar(20) NOT NULL,
  `agama_anak_empat` varchar(20) NOT NULL,
  `status_kawin_anak_empat` varchar(20) NOT NULL,
  `warga_negara_anak_empat` varchar(20) NOT NULL,
  `pendidikan_terakhir_anak_empat` varchar(20) NOT NULL,
  `pekerjaan_anak_empat` varchar(20) NOT NULL,
  `status_keluarga_anak_empat` varchar(20) NOT NULL,
  `no_paspor_anak_empat` varchar(20) NOT NULL,
  `no_kitab_anak_empat` varchar(20) NOT NULL,
  `nama_ayah_anak_empat` varchar(20) NOT NULL,
  `nama_ibu_anak_empat` varchar(20) NOT NULL,
  `nik_anak_lima` varchar(20) NOT NULL,
  `nama_anak_lima` varchar(20) NOT NULL,
  `tempat_lahir_anak_lima` varchar(20) NOT NULL,
  `tanggal_lahir_anak_lima` varchar(20) NOT NULL,
  `jenis_kelamin_anak_lima` varchar(20) NOT NULL,
  `agama_anak_lima` varchar(20) NOT NULL,
  `status_kawin_anak_lima` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `spektp`
--
